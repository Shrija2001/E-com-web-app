...
<h1 class="text-center text-danger">Admin Signup</h1>

<div class="container w-50">
 
<form action="adsignup" method="post">
...
<input class="form-control" id="uemail" name="uemail">
...
<a href="adminlogin.jsp" class="btn btn-info mt-5">Login</a>
